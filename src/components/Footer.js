          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div className="col-span-1 lg:col-span-1">
              ...
              <div className="flex gap-4">
                {/* Social Icons */}
                <a href="#" className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-gray-300 hover:bg-blue-600 hover:text-white transition-colors" aria-label="Twitter">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-400 text-sm">123 Tech Street, Digital City, CA</span>
                </li>
                <li className="flex items-center gap-3">
                  ...
                  <span className="text-gray-400 text-sm">hello@technova.com</span>
                </li>
                <li className="flex items-center gap-3">
