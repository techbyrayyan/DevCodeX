...
export default function Footer() {
  ...
  return (
    <footer
      className="pt-16 pb-12 font-sans"
      style={{ backgroundColor: 'rgba(5,5,5,0.7)', backdropFilter: 'blur(8px)', borderTop: '1px solid #27272a', color: '#a1a1aa' }}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Main Grid */}
        <div
          className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8 pb-12"
          style={{ borderBottom: '1px solid #27272a' }}
        >
          
          {/* Brand Info */}
          <div className="lg:col-span-1 space-y-4">
            <Link href="/" className="inline-flex items-center group -mt-1">
              <Image
                src="/logo4.png"
                alt="DevCodeX Logo"
                width={130}
