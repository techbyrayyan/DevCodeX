...
export default function Sidebar() {
  ...
  return (
    <aside className={cn(
      "glass border-r border-slate-200 dark:border-slate-800 flex flex-col z-40 transition-all duration-300",
      "fixed inset-y-0 left-0 lg:sticky lg:top-[81px] lg:h-[calc(100vh-81px)]", // mobile vs desktop positioning
