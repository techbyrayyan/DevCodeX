  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
      <div className="text-center mb-8">
        <span className="text-xs sm:text-sm font-bold text-blue-600 tracking-wider uppercase mb-3 block">What We Do</span>
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#0B1B3D] mb-4">Our Services</h2>
